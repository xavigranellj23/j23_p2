...
InteraktingSlider.prototype.getCommande = function(){
	/*
	<div id="btns">
     <div class="arrows"><a href="#"><img src="images/prev.jpg" width="10" height="22" alt="previa" /></a></div>
    <div class="num-img"><a href="#">1</a></div>
    <div class="num-img"><a href="#">2</a></div>
    <div class="num-img"><a href="#">3</a></div>
    <div class="num-img"><a href="#">4</a></div>
    <div class="num-img"><a href="#">5</a></div>
    <div class="arrows"><a href="#"><img src="images/next.jpg" width="10" height="22" alt="previa" /></a></div>
</div>
	*/

	var html = '';
	//html += "<div class='arrows'><a href='#' onclick='interaktingslider.turnLeft();return false;'>Prev</a></div>";
	html += "<div class='arrows'><a href='#' onclick='interaktingslider.turnLeft();return false;'><img width='10px' height='22px' alt='previa' src='http://212.34.128.78/~magento/twenty_sports/media/prev.jpg'></a></div>";
	for (i=0;i<this.countSlides();i++){
		html += "<div class='num-img'><a href='#' id='button"+i+"' onclick='interaktingslider.goTo("+i+");return false;'><span>"+(i+1)+"</span></a></div>";		
	}
	html += "<div class='arrows'><a href='#' onclick='interaktingslider.turnRight();return false;'><img width='10px' height='22px' alt='previa' src='http://212.34.128.78/~magento/twenty_sports/media/next.jpg'></a></div>";
	//html += "<div style='margin-left:6px;' class='prev-next'><a href='#' onclick='interaktingslider.turnRight();return false;'>Next</a></div>";
	return html;
}
...
InteraktingSlider.prototype.setCurrentButton = function(){
	for (i=0;i<this.countSlides();i++){
		...
		if(this.isCurrentSlide(i)){
			button.setAttribute("class", "num-img-hover-button"); 
			button.setAttribute("className", "num-img-hover-button");
		}
		else{
...
InteraktingSlider.prototype.show = function(){
	...
	if(this.isManualMode()){
		...
		if (div){
			div.innerHTML += '<div id="btns">'+this.getCommande()+'</div>';
		}
	}
