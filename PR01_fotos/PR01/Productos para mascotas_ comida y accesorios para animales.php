...
<link rel="stylesheet" type="text/css" href="./Productos para mascotas_ comida y accesorios para animales_files/estilo.css" media="all" />
...
// ]]></script>
    ...
    <form class="contact_form" action="./Productos para mascotas_ comida y accesorios para animales_files/151014_exemple_connexio_BD_4.php" method="POST">
    <h1>Formulario</h1>

      <label for="nombre">Perdido / Encontrado:</label><br/><br/>
      <input type="radio" name="perdtrob" value="p">Perdido<br/>
      <input type="radio" name="perdtrob" value="e">Encontrado<br/><br/>

      <label for="nombre">Tipo Animal:</label><br/><br/>
      <input type="checkbox" name="tipo[]" value="1">Perro<br/>
      <input type="checkbox" name="tipo[]" value="2">Gato<br/>
      <input type="checkbox" name="tipo[]" value="3">Pájaro<br/>
      <input type="checkbox" name="tipo[]" value="4">Otros<br/><br/>
