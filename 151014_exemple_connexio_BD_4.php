...
// ]]></script>
    ...
    <?php
      ...
      $sql = "SELECT tbl_anunci.anu_nom, tbl_anunci.anu_contingut, tbl_anunci.anu_data, tbl_anunci.anu_foto, tbl_raca.raca_nom, 
               ...
               tbl_tipus_animal.tipus_anim_nom, tbl_anunci.anu_tipus
      ...
      if(isset($_REQUEST['perdtrob'])){
        ...
        if ($radiobutton=="Perdut"){
          $sql.= "WHERE ";
          $sql.= " tbl_anunci.anu_tipus='$radiobutton'" ;
        }else{
          $sql.= " tbl_anunci.anu_tipus='$radiobutton'" ;   
          }
      }
      ...
      if(isset($_REQUEST['tipus_animal'])){
        ...
        if ($tipus_animal=="Gos"){
          $sql.= " tbl_tipus_animal.tipus_anim_nom='$tipus_animal' " ;
        }
        if ($tipus_animal=="Gat"){
          $sql.= " tbl_tipus_animal.tipus_anim_nom='$tipus_animal' " ;
        }
      ...
      if($datos== TRUE){
        while($prod = mysqli_fetch_array($datos)){
          ...
          echo "<b>Municipio:</b> $prod[municipi_nom]<br/>";
